...
const projectNine = document.querySelector(".p-9");
const projectTen = document.querySelector(".p-10");
const projectEleven = document.querySelector(".p-11");
  ...
  switch (activeCorner) {
    ...
    case "bottom-left":
      if (window.innerWidth <= 600) {
        ...
        projectSeven.style.width = "70%";
        projectSeven.style.margin = "auto auto 0.5rem";
        projectEight.style.width = "70%";
        projectEight.style.margin = "auto auto 0.5rem";
        projectNine.style.width = "70%";
        projectNine.style.margin = "auto auto 0.5rem";
        projectTen.style.width = "70%";
        projectTen.style.margin = "auto auto 0.5rem";
        projectEleven.style.width = "70%";
        projectEleven.style.margin = "auto auto 0.5rem";
        ...
        projectSix.style.margin = "auto auto 0.5rem";
        projectSeven.style.width = "40%";
        projectSeven.style.margin = "auto auto 0.5rem";
        projectEight.style.width = "40%";
        projectEight.style.margin = "auto auto 0.5rem";
        projectNine.style.width = "40%";
        projectNine.style.margin = "auto auto 0.5rem";
        projectTen.style.width = "40%";
        projectTen.style.margin = "auto auto 0.5rem";
        projectEleven.style.width = "40%";
        projectEleven.style.margin = "auto auto 0.5rem";
      } else {
        ...
        projectNine.style.width = "100%";
        projectTen.style.width = "100%";
        projectEleven.style.width = "100%";
      }
      break;
...
trBtn.onclick = function () {
  if (activeCorner === "top-right") {
    ...
    trBtn.innerHTML = "&uarr;<br/>Knowledge";
